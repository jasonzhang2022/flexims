 ...
 * 
 */
public class TestInheritanceMetaSource extends XMLMetadataSource {
	...
	public XMLEntityMappings getEntityMappings(Map<String, Object> properties, ClassLoader classLoader, SessionLog log) {
		...
		if (hasRel) {
			...
			// MetaSourceBuilder.addID(test1);
			// MetaSourceBuilder.addVersion(test1);
			MetaSourceBuilder.AddBasicProperty(test1, "fname1", "String");
			MetaSourceBuilder.establishInheritance(test1, test);
